...
<!-- 
  INCLUDE REQUIRE AND REQUIRE ONCE ARE USED TO INCLUDE EXTERNAL PHP
  FILES TO A PHP FILE
-->
...
?>
    ...
    <img src="/php-crash/feedback/img/croped.jpeg" class="w-25 mb-3" alt="" style="border-radius: 50%;">
    <h2>Feedback</h2>
    <p class="lead text-center">Leave feedback for Owuor Ian</p>
